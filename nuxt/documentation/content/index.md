...
::card-grid
  :::card-grid-item{href="/explanation/" title="Explanation" description="Understanding-oriented discussions of architecture and design"}
  :::

  :::card-grid-item{href="/tutorials/" title="Tutorials" description="Learning-oriented guides to help you get started"}
  :::

  :::card-grid-item{href="/guides/" title="Guides" description="Task-oriented how-to guides and live example sandboxes"}
  :::
