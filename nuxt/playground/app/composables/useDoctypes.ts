...
// Eagerly load all JSON doctype definitions from the root-level doctypes/
// folder — the same folder the module's docbuilder reads and writes
// (doctypesDir resolves against rootDir, so it sits beside app/ and server/).
