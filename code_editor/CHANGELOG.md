...
- a859205: The stylesheet the build emits is now reachable as `@stonecrop/code-editor/styles`, which the exports map previously blocked.
...
- Drop the unused data-theme stylesheets from the published bundle
...
- renovate code-editor component
...
- remove side effects from code editor
...
- use single container for code editor
