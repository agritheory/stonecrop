...
- Externalize all bare imports — bundling graphql/postgraphile created a second graphql realm that risks instanceof failures in the host plugin chain; clean dist on every build
