 ...
 * - dist/aform.js does NOT contain an external @stonecrop/themes import
 *
 * After the refactor:
 * 1. Remove @import url('@stonecrop/themes/default.css') from dead login.css
 ...
 */
describe('aform build output - theming', () => {
	const distDir = path.resolve(__dirname, '../dist')
	const cssPath = path.join(distDir, 'assets/index.css')
	const jsPath = path.join(distDir, 'aform.js')
	...
	it('dist/aform.js should import theme as external dependency', () => {
	...
	it('dist/aform.js should still auto-inject structural CSS', () => {
