import { defineComponent, resolveComponent, openBlock, createBlock, withCtx, createElementVNode, inject, ref, computed, provide, resolveDynamicComponent, reactive, nextTick, createElementBlock, normalizeStyle, withKeys, toDisplayString, withDirectives, createCommentVNode, renderSlot, vShow, Fragment, renderList, createTextVNode, onMounted, watch, normalizeClass, mergeProps, createVNode, resolveDirective, vModelText } from "vue";
...
const _hoisted_1$3 = /* @__PURE__ */ createElementVNode("div", null, [
...
function _sfc_render$2$1(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.columns.length ? (openBlock(), createElementBlock("thead", _hoisted_1$1$1, [
    createElementVNode("tr", _hoisted_2$2, [
