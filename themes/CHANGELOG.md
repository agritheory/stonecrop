...
- Quote the Arimo font-family value so it resolves consistently
...
- set font family from defined variables
...
- added rgb variable for loading gradient color
...
- update table modal positioning
