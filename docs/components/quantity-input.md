...
const quantityValueHeaders = ["Field", "Type", "Description"]
const quantityValueRows = [
...
<<< ../.vitepress/theme/demos/QuantityInputDemo.vue
...
<ApiDataTable :headers="quantityValueHeaders" :rows="quantityValueRows" />
