...
{ columns: [TableColumn](./atable.tablecolumn.md)<!-- -->\[\]; rows: [TableRow](./atable.tablerow.md)<!-- -->\[\]; id?: string; config?: [TableConfig](./atable.tableconfig.md)<!-- -->; modal?: [TableModal](./atable.tablemodal.md)<!-- -->; }
