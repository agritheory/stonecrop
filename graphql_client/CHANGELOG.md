...
- Select height in the meta queries so the field reaches the client
...
- Remove native PostGraphile query builder and getNativeRecord/getNativeRecords; link display enrichment stays in graphql-middleware.
...
- remove query-specific construction logic
...
- update return typings for client methods
...
- use window.fetch for compatibility
...
- add custom deserializer for graphQL responses
