import { shallowRef, unref, computed, reactive, nextTick, defineComponent, inject, h, provide, ref, watch, getCurrentInstance, watchEffect, effectScope, openBlock, createElementBlock, createElementVNode, toDisplayString, onMounted, Fragment, renderList, createBlock, resolveDynamicComponent, mergeProps, normalizeClass, resolveComponent, createVNode } from "vue";
...
const Records = () => import("./Records.ceaa7966.mjs");
const Doctype$2 = () => Promise.resolve().then(() => Doctype$1);
const routes = [
  { path: "/", component: _sfc_main$2, meta: { transition: "slide-up" } },
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useStonecrop();
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("h3", null, "Records");
    };
  }
});
defineComponent({
