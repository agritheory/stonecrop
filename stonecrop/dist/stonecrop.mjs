import { shallowRef, unref, computed, reactive, nextTick, defineComponent, inject, h, provide, ref, watch, getCurrentInstance, watchEffect, effectScope, getCurrentScope, onScopeDispose, openBlock, createElementBlock, createElementVNode, toDisplayString } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "Home",
  setup(__props) {
    const useState = createGlobalState(() => useStorage("stonecrop", {
      name: "Banana",
      color: "Yellow",
      size: "Medium"
    }));
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _hoisted_2,
        createElementVNode("pre", null, " " + toDisplayString(unref(useState)) + " ", 1)
      ]);
    };
  }
});
