...
- Externalize @stonecrop, @vue-flow, and @dagrejs/dagre dependencies from the bundle; clean dist on every build
...
- cleanup pending issues with node-editor
