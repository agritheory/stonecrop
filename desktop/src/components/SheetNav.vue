	...
	<footer>
		<ul class="tabs">
			<li class="hidebreadcrumbs"
				...
				@keydown.enter="toggleBreadcrumbs"
			>
				<a
					tabindex="0"
				><div
					:class="rotateHideTabIcon"
				>×</div></a>
			</li>
			<li class="hometab"
				@click="navigateHome"
			...
			>
				...
				>
				<span
					:style='{"display" : (searchVisibile? "none" : "block" )}'
				>
				<svg style="width: 11pt">
					<g
						transform="matrix(-0.08088215,0,0,0.08088215,9.8016177,3.1263021e-6)">
						<path
			...
			>
				<router-link
					tabindex="0"
					 :to="breadcrumb.to"> {{ breadcrumb.title }}
				</router-link>
			</li>
...
.tabs .router-link-active:after,   .tabs .router-link-active:before, 
.tabs .router-link-active a:after, .tabs .router-link-active a:before {
  content: "";
	
}
.tabs .router-link-active:before, .tabs .router-link-active:after {
