...
import { StonecropGraphQLTypeDefs } from '@agritheory/graphql-client'
...
export function makeServer() {
	return createServer({
		...
		fixtures: {
			schemas: { schema: StonecropGraphQLTypeDefs },
		},
		...
		routes() {
			...
			const graphQLHandler = createGraphQLHandler(StonecropGraphQLTypeDefs, this.schema, {
