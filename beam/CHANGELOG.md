...
- Externalize @vueuse, mqtt, and onscan.js dependencies from the bundle; clean dist on every build
...
- use two-column layout for beam filters
...
- denominator condition to be shown
...
- add debounce to list item input
...
- export beam metadata components
...
- Added metadata component to BEAM
