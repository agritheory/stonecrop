...
- Externalize @vueuse and @stonecrop dependencies from the bundle; clean dist on every build
...
- combine AExpansionRow and ARow
...
- add row-click and row-open event emitters
...
- change schema value from type -> fieldtype
...
## 0.4.35
Wed, 24 Sep 2025 13:45:34 GMT

### Updates

- Tests ACell added - non-editable cases
...
- allow default expansion levels to tree-views
...
- allow dependency graphs to be disabled
...
- build display and table properties dynamically
...
- sync table updates with the store
...
- send cell update emit values as object
...
- amodal uses cell and row sizes to calculate position
...
- added gradient to changed rows in atable
...
- added atable loading component
...
- replace crypto uuid generation with randomly generated hash string
...
- change cell style on value update
...
- use fixed positioning for modal
...
- added pinned columns via sticky positioning
...
- allow modal component to be set dynamically
...
- Add context to cell format function
