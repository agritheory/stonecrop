...
- Externalize @vueuse dependencies from the bundle; drop unused xstate dependency; add a test suite for the keyboard-navigation and visibility composables; clean dist on every build
...
- improve typing for keyboard navigation selectors
...
- Update keyboard navigation composable
